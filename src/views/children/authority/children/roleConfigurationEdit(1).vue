<template>
    <div class="particulars-container myauthorityConfigEdit">
            ...
            <div class="parCenter">
                ...
                <el-form ref="form" :model="form" label-width="160px" label-position="left">
                    <el-form-item id="firstElItem"  label="角色名称">
                        <el-input v-model="form.name2" placeholder="运营"></el-input>
                    </el-form-item>
                    <p class="form-p">权限</p>
                    ...
                    <el-form-item label="精品课堂" prop="type">
                        <el-checkbox-group v-model="ruleForm.type2" @change="selectCk">
...
<script>
    export default {
        ...
        methods:
        {
            ...
            selectCk()
            {
                console.log("您选中的 项目有"+this.ruleForm.type2);
            }
        }
    }
</script>
...
<style lang="less">
    .myauthorityConfigEdit .el-checkbox__inner
    {
        position:relative;
        top:-4px;
    }
