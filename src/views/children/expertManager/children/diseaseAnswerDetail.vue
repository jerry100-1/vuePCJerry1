<template>
    <div class="particulars-container">
        ...
        <div class="particulars-info" style="border-bottom:none;">
            ...
            <img class="leftImg1" src="@/assets/images/leftimg2.png" alt="">

            <div class="centerCtn">
                <h3 class="cellElement1" v-html="title"></h3>
                <div class="cellElement2">
                    <span class="cellElement2-1" v-html="updatetime">2019-03-06</span>
                    <span class="cellElement2-2" v-html="name">传控健康</span>
                </div>
                <div class="cellElement3" v-html="answer">
                ...
                <h5 class="cellElement4" v-html="aname">XXXXXX有限公司</h5>
...
<script>
    export default {
        ...
        created() {
            ...
            console.log(this.$route.params.answer);
            this.answer=this.$route.params.answer;
            console.log(this.$route.params.type);
            this.type=this.$route.params.type;
            console.log(this.$route.params.status);
            this.status=this.$route.params.status;
            console.log(this.$route.params.updatetime);
            this.updatetime=this.$route.params.updatetime;
            console.log(this.$route.params.createtime);
