<template>
    <div class="particulars-container myexpertListEditcontainer" style="overflow-y:auto!important;max-height:1100px!important;">
        ...
        <div class="particulars-info healthList" style="border-bottom:none;">
            ...
            <div class="parCenter" style="height:1200px;!important;">
                ...
                <el-form label-width="140px">
                    ...
                    <el-form-item label="所在的卫生所">
                        ...
                        <el-select v-model="cid" @change="" style="text-overflow:ellipsis;white-space:nowrap" placeholder="请选择" id="seleId1">
                            <el-option style="width:220px!important;"
...
<script>
    export default {
        ...
        methods:
            {
                ...
                getAllClinicList(){
                    ...
                    this.$http.get('/admin/clinic/allList',{
                        ...
                        console.log("所有的诊所数据是:"+this.allClinicList);
                ...
                editExpert()
                {
                    ...
                    if(this.type=="儿保咨询")
                    {
                        // alert("1");
                        this.type=1;
                    }else if(this.type=="接种咨询")
                    {
                        // alert("2");
                        this.type=2;
                    }else if(this.type=="成人咨询")
                    {
                        // alert("3");
                        this.type=3;
                    }
                    ...
                    {
                        this.sday=1;
                    }else if(this.sday=="星期二")
                    {
                        this.sday=2;
                    }else if(this.sday=="星期三")
                    {
                        this.sday=3;
                    }else if(this.sday=="星期四")
                    {
                        this.sday=4;
                    }else if(this.sday=="星期五")
                    {
                        this.sday=5;
                    }else if(this.sday=="星期六")
                    {
                        this.sday=6;
                    }else if(this.sday=="星期天")
                    {
                        this.sday=7;
                    }
                    //一周结束星期几
                    ...
                    {
                        this.eday=1;
                    }else if(this.eday=="星期二")
                    {
                        this.eday=2;
                    }else if(this.eday=="星期三")
                    {
                        this.eday=3;
                    }else if(this.eday=="星期四")
                    {
                        this.eday=4;
                    }else if(this.eday=="星期五")
                    {
                        this.eday=5;
                    }else if(this.eday=="星期六")
                    {
                        this.eday=6;
                    }else if(this.eday=="星期天")
                    {
                        this.eday=7;
                    }
        ...
        created()
        {
            ...
            console.log("此页面接收到的type值是:"+this.$route.params.type);
            ...
            //一周开始星期几
            if(this.$route.params.sday=="1")
            {
                this.sday="星期一";
            }else if(this.$route.params.sday=="2")
            {
                this.sday="星期二";
            }else if(this.$route.params.sday=="3")
            {
                this.sday="星期三";
            }else if(this.$route.params.sday=="4")
            {
                this.sday="星期四";
            }else if(this.$route.params.sday=="5")
            {
                this.sday="星期五";
            }else if(this.$route.params.sday=="6")
            {
                this.sday="星期六";
            }else if(this.$route.params.sday=="7")
            {
                this.sday="星期天";
            }
            //一周结束星期几
            if(this.$route.params.eday=="1")
            {
                this.eday="星期一";
            }else if(this.$route.params.sday=="2")
            {
