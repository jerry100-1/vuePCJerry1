...
<script>
    export default {
        ...
        methods:
            {
                ...
                getAllClinicList(){
                  ...
                  //  alert(token);
                    this.$http.get('/admin/symptom/alltypeWeb',{
                        ...
                        console.log("请求所有病症分类数据开始666666666666666...")
                ...
                submitBtn66()
                {
                    ...
                    //
                    // alert("你好,你提交的病症名称是"+this.title);
                    // alert("你好,你提交的病症答案是"+this.answer);
                    // alert("你好,你提交的病症类型是"+this.value2);
                    ...
                    this.$http.get('/admin/symptom/add',{
                        ...
                        console.log("这是所有编辑解答接口返回给我的数据...")
                        console.log(response);
                        if(response.data.status==1)
                        {
                            this.$message.success("编辑病症解答成功!");
                            this.$router.push("/home/expertManager/diseaseAnswer");
                        }else
                        {
                            this.$message.error("编辑病症解答失败!")
                        }
                        //this.userList=response.data.result.list;
                        //获取全国省区数据;
                        //this.code=response.data.result.list.
        ...
        created()
        {
            ...
            // alert("你好,你传过来的id是"+this.$route.params.id);
            // alert("你好,你传过来的分类中文名name是"+this.$route.params.name);
            // alert("你好,你传过来的分类id --type是"+this.$route.params.type);
            this.id=this.$route.params.id;
            this.title=this.$route.params.title;
            this.answer=this.$route.params.answer;
          //  this.value2=this.$route.params.name;
            //应该传递下面的数字型的id  下面的type就是所谓的要传的id
            this.value2=this.$route.params.type;
