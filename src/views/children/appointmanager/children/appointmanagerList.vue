        ...
        <div class="articleList-main">
            <div class="block" style="padding-left:0px!important;">
                ...
                <el-row class="wrpaAllBtn"  style="float:left">
                    ...
                    <el-button type="primary"  style="border-color:#00d3c2!important;color:#00d3c2!important;" id="btnSmall1">排队中</el-button>
        ...
        methods: {
            ...
            getAppointmentList(keyword='',starttime='',endtime=''){
                ...
                this.$http.get('/admin/bespeak/getlist',{
                    ...
                    console.log("排队中状态共有数据"+response.data);
                    ...
                    //
                    // this.appointmentList.filter(item => item.statusText=="排队中" );
                    // this.appointmentList=this.appointmentList.filter(item => item.statusText=="排队中" );
