            ...
            <div class="block" style="padding-left:0px!important;">
                ...
                <keep-alive>
                    <el-row class="wrpaAllBtn"  style="float:left">
                        ...
                        <el-button type="primary"  style="" id="btnSmall1" @click="goList">排队中</el-button>

                        <el-button type="primary" style="border-color:rgba(0,0,0,0.36)!important;" @click="goNumber" id="btnSmall3">已叫号</el-button>

                        <el-button type="primary"  @click="goCancelPage" id="btnSmall8" style="line-height:0px!important">已取消</el-button>

                        <el-button type="primary"  @click="goFinishPage" id="btnSmall9" style="border:1px solid #00d3c2!important;color:#00d3c2;line-height:0px!important">已完成</el-button>
        ...
        methods: {
            ...
            getAppointmentList(keyword='',starttime='',endtime=''){
                ...
                this.$http.get('/admin/bespeak/getlist',{
                    ...
                    //
                    // this.appointmentList.filter(item => item.statusText=="已完成" );
                    // this.appointmentList=this.appointmentList.filter(item => item.statusText=="已完成" );
                    // // Vue.$set(this.orderList);
                    // //  alert("当前的数组的长度是"+this.orderList.length);
                    // this.length=this.appointmentList.length;
                    // console.log("这是过滤后的数据:"+this.appointmentList.filter(item => item.statusText=="已完成" ))
