            ...
            <div class="parCenter">
                <el-form label-width="120px">
                    <el-form-item label="标题">
                        <el-input v-model="title" placeholder="请输入轮播图标题"></el-input>
                    </el-form-item>
                    <el-form-item label="链接">
                        <el-input v-model="link" placeholder="请输入轮播图相关链接"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="所属模块区域">
                        <el-input v-model="place" placeholder="请输入轮播图所属板块区域"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item>
                        ...
                        <el-button id="btnSub36"  type="primary" @click="commitAddUserBanner" style="width:160px;margin-left:20px;">提交</el-button>
        ...
        methods:
            {
                ...
                commitAddUserBanner()
                {
                    ...
                    // if(this.place!="首页"&&this.place!="微课堂"&&this.place!="个人中心"&&this.place!="医生问答")
                    // {
                    //     this.$message.error("亲,请在四大模块中选择:1:首页 2 微课堂 3:个人中心 4:医生问答");
                    //     return
                    // }
                    if(this.status=="")
                    {
                    ...
                    this.$http.get('/admin/lunboimgs/add',{
                        ...
                        console.log("这是新增轮播图接口返回的数据..."+response);
