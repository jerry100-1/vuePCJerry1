            ...
            <div class="parCenter">
                <el-form label-width="100px">
                    ...
                    <el-form-item label="地址坐标经度">
                        <el-input v-model="lng" disabled="disabled" placeholder="详细经纬度请在地图搜索区进行精确定位"></el-input>
                    </el-form-item>
                    <el-form-item label="地址坐标维度">
                        <el-input v-model="lat" disabled="disabled" placeholder="详细经纬度请在地图搜索区进行精确定位"></el-input>
                    </el-form-item>
                    ...
                    <!--</el-form-item>-->
                    <el-form-item>
                        <el-button id="kkBtn" @click.capture="goNextPage" style="margin-left:20px" type="primary">下一步</el-button>
                    </el-form-item>
        ...
        methods:
            {
                ...
                goNextPage()
                {
                   ...
                   if(this.searchValue3=="")
                   {
                    ...
                    // alert("你好,你提交的title是"+this.title);
                    // alert("你好,你提交的phone是"+this.phone);
                    // alert("你好,你提交的是province"+this.searchValue);
                    // alert("你好,你提交的city是"+this.searchValue2);
                    // alert("你好,你提交的area是"+this.searchValue3);
                    // alert("你好,你提交的lng是"+this.lng);
                    // alert("你好,你提交的lat是"+this.lat);
                    // alert("你好,你提交的address是"+this.address);
                    // alert("你好,你提交的province_code是"+this.province_code);
                    // alert("你好,你提交的city_code是"+this.city_code);
                    // alert("你好,你提交的area_code是"+this.area_code);
                ...
                submitTo()
                {
                    ...
                    //     }
                    // }).then(response=>{
                    //     console.log("这是新增卫生所之后请求接口返回给我的数据开始...")
                    //     console.log(response);
                    //     //this.userList=response.data.result.list;
