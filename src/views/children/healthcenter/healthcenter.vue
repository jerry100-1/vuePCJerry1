<template>
    <div class="user-container">
        <div class="left-nav" style="height:1200px!important;">
            ...
            <router-link tag="div" to="/home/healthcenter/healthcenterList" :class="{'nav-item':true,'bg':show}">
                <h4>卫生所列表</h4>
        ...
        <div class="right-main" style="height:1200px!important;">
